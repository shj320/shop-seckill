...
public class OrderPayController {
    ...
    @RequestMapping("/pay")
    public Result<String> pay(String orderNo,
                              Integer type){
    ...
    public Result<String> refund(String orderNo){
        ...
        if(OrderInfo.PAYTYPE_ONLINE.equals(byOrderNo.getPayType())){
            //在线支付
            orderInfoService.refundOnline(byOrderNo);
        }else {
            //积分支付
            orderInfoService.refundIntegral(byOrderNo);
