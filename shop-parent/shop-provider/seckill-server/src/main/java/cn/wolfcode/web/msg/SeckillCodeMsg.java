...
public class SeckillCodeMsg extends CodeMsg {
    ...
    public static final SeckillCodeMsg SECKILL_TIME_OUT = new SeckillCodeMsg(500211,"时间未到");
    public static final SeckillCodeMsg NO_LOOK_OTHER = new SeckillCodeMsg(500212,"不能查看别人订单");
    public static final SeckillCodeMsg NOT_MANY_PAY = new SeckillCodeMsg(500213,"支付过了");
}
